            ...
            <div class="bg-white border border-slate-100 shadow-sm sm:rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-4"
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" required placeholder="Contoh: Kerajinan Tangan" x-model="name"
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5" placeholder="Masukkan deskripsi lengkap tentang kategori..." x-model="description"
                    ...
                    <div class="flex justify-end gap-2 pt-4">
                        ...
                        <button type="submit" class="text-white font-bold text-sm px-6 py-3 rounded-2xl transition-all shadow-md"
                                ...
                                :class="isFormInvalid ? 'opacity-50 cursor-not-allowed bg-slate-400' : 'bg-indigo-600 hover:bg-indigo-700'">Simpan Kategori</button>
                    </div>
                </form>
            </div>
        </div>
