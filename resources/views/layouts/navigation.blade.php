        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-xl font-black bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">
                        TokoKita
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(auth()->user()->isSeller())
                            ...
                            <x-nav-link :href="route('seller.vouchers.index')" :active="request()->routeIs('seller.vouchers.*')">
                                {{ __('Voucher & Promosi') }}
                            </x-nav-link>
                            <x-nav-link :href="route('seller.shop.edit')" :active="request()->routeIs('seller.shop.edit')">
                                {{ __('Profil Toko') }}
                            </x-nav-link>
