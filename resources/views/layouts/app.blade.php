                            ...
                            <div class="glass-card shadow-premium rounded-[24px] p-6 sticky top-24 space-y-2 border border-slate-100/50">
                                ...
                                @elseif(auth()->user()->isAdmin())
                                    ...
                                    <a href="{{ route('admin.categories.index') }}" 
                                       class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all hover:bg-indigo-50/50 hover:text-indigo-600 {{ request()->routeIs('admin.categories.*') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}">
